...
//go:generate go -C ../../tools run ./tasknamegen -path=../../snd/ce6866p-yang -modules=huawei-vlan,huawei-ifm,huawei-system,huawei-pub-type,huawei-extension,huawei-bgp,huawei-network-instance,huawei-analysis-collector,huawei-anyflow,huawei-arp,huawei-bd,huawei-cfg,huawei-devm,huawei-driver,huawei-dsa,huawei-ecc,huawei-evpn,huawei-fib,huawei-ftpc,huawei-grpc,huawei-hwtacacs,huawei-ifm-trunk,huawei-ip,huawei-l3-multicast,huawei-lacp,huawei-license,huawei-lldp,huawei-loadbalance,huawei-m-lag,huawei-mac-flapping-detect,huawei-macsec,huawei-microsegmentation,huawei-mirror,huawei-monitor-link,huawei-mstp,huawei-multicast,huawei-mvpn,huawei-nqa,huawei-ntp,huawei-nvo3,huawei-openflow-agent,huawei-ospfv2,huawei-ospfv3,huawei-packetevent,huawei-qos,huawei-rsa,huawei-sflow,huawei-sm2,huawei-snmp,huawei-syslog,huawei-system-resources-usage,huawei-unicast-forward,huawei-vrrp,huawei-vty,huawei-vxlan-ext,huawei-vxlan-path-detect,openconfig-telemetry -output=../internal/yangschema/taskname.gen.go -package=yangschema

// SND blacklist（CN-03）：构建期 revision 匹配后生成模块名集合，运行期零 snd 文件依赖。
//go:generate go -C ../../tools run ./blacklistgen -blacklist=../../snd/ce6866p-yang/blacklist.xml -path=../../snd/ce6866p-yang -output=../internal/yangschema/blacklist.gen.go -package=yangschema

// SND left-tree（LT-01）：构建期生成分组树 + 叶子根容器映射 + 模块级 container/rpc
// 子节点（双语标签自 snd res 烘焙），运行期零 snd 文件依赖。
//go:generate go -C ../../tools run ./lefttreegen -tree=../../snd/webui/template/left-tree.json -path=../../snd/ce6866p-yang -res=../../snd/resources/i18n -output=../internal/yangschema/lefttree.gen.go -package=yangschema

// YANG rpc 定义（RPC-01）：构建期以 goyang 从 YANG 源提取每模块 rpc（名称/高危/
// 输入叶），ygot 运行期 schema 不含 rpc。模块清单 = 厂商 taskname 清单 +
// acl/bfd/pic/routing（左树 rpc 节点口径对齐：凡可解析叶展出的 rpc 必有定义，
// 守护测试 TestLeftTreeRPCNodesBackedByModuleRPCs）。
//go:generate go -C ../../tools run ./rpcgen -path=../../snd/ce6866p-yang -modules=huawei-acl,huawei-bfd,huawei-pic,huawei-routing,huawei-vlan,huawei-ifm,huawei-system,huawei-pub-type,huawei-extension,huawei-bgp,huawei-network-instance,huawei-analysis-collector,huawei-anyflow,huawei-arp,huawei-bd,huawei-cfg,huawei-devm,huawei-driver,huawei-dsa,huawei-ecc,huawei-evpn,huawei-fib,huawei-ftpc,huawei-grpc,huawei-hwtacacs,huawei-ifm-trunk,huawei-ip,huawei-l3-multicast,huawei-lacp,huawei-license,huawei-lldp,huawei-loadbalance,huawei-m-lag,huawei-mac-flapping-detect,huawei-macsec,huawei-microsegmentation,huawei-mirror,huawei-monitor-link,huawei-mstp,huawei-multicast,huawei-mvpn,huawei-nqa,huawei-ntp,huawei-nvo3,huawei-openflow-agent,huawei-ospfv2,huawei-ospfv3,huawei-packetevent,huawei-qos,huawei-rsa,huawei-sflow,huawei-sm2,huawei-snmp,huawei-syslog,huawei-system-resources-usage,huawei-unicast-forward,huawei-vrrp,huawei-vty,huawei-vxlan-ext,huawei-vxlan-path-detect,openconfig-telemetry -output=../internal/yangschema/rpc.gen.go -package=yangschema

// 业务意图模型的 task-name 与厂商模型不同源（backend/internal/yang/models 入库
// 模型，无 submodule 依赖），独立生成文件与变量避免冲突。
//go:generate go -C ../../tools run ./tasknamegen -path=../internal/yang/models -modules=usmp-business-vlan -output=../internal/yangschema/taskname_business.gen.go -package=yangschema -var=BusinessTaskNames
