...
- [EviewUI切换实施台账](eviewui-switch-implementation.md) — **进行中(2026-08-17,PR#342-#353)**：闸门通过、路线乙(组件库先换on React19,运行时+全家桶推波C)、组2先行波+组3核心+组4全24桥合入、混合模式机制(vendor types/子路径stub/覆盖率窗口口径)、实录坑八条；**当前卡点=等内网bridge-report回传→组5接线**；续作前必读
