...
- **升级/新增依赖前必查** `go list -m -json mod@ver` 的 GoVersion ≤1.22，否则 go get 会静默把 go 指令抬上去。当前钉住的天花板：ygot v0.29.20（v0.29.22 起就要 1.23.4）、x/crypto v0.33.0（仍含 CVE-2024-45337/CVE-2025-22869 两个 SSH 修复；再往后的补丁吃不到）、x/sys v0.30、x/net v0.35、otel v1.35、x/exp@20241009（gnmi 同款）、swag v1.16.4（勿让 tidy 抬到 v1.16.6，契约生成物会漂）。
